...
The current source prepares **0.6.0 build 13**, adding a menu-bar app and metric
...
```bash
APP_VERSION=0.6.0 APP_BUILD=13 CONFIGURATION=release bash scripts/build-app.sh
